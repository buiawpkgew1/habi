...
import net.habiclient.settings.AttackSpeedSliderSetting;
import net.habiclient.settings.CheckboxSetting;
import net.habiclient.settings.PauseAttackOnContainersSetting;
import net.habiclient.settings.filterlists.EntityFilterList;
import net.habiclient.settings.filters.*;
