...
import net.habiclient.hacks.autofish.AutoFishDebugDraw;
import net.habiclient.hacks.autofish.AutoFishRodSelector;
import net.habiclient.mixinterface.IFishingBobberEntity;
